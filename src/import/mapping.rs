...
use crate::import::{
    AttachType, DeferredItem, ImportIR, IrDgTrigger, IrItem, IrMob, IrQuest, IrResetKind, IrRoom, IrShop, IrTrigger,
    IrZone, MappingOptions, Plan, PlannedArea, PlannedDoor, PlannedExit, PlannedItem, PlannedMobile, PlannedQuest,
    PlannedRoom, PlannedShopOverlay, PlannedSpawn, PlannedSpawnDep, PlannedTriggerOverlay, Severity, SourceLoc,
...
use crate::types::{
    ...
    ItemTriggerType, ItemType, LiquidType, MobileFlags, MobileTrigger, MobileTriggerType, QuestData, QuestObjective,
    QuestReward, RoomFlags, RoomTrigger, RoutineEntry, SpawnDestination, SpawnEntityType, TriggerType, WearLocation,
};
...
fn translate_quest(q: &IrQuest, warnings: &mut Vec<Warning>) -> Option<PlannedQuest> {
...
fn first_line_compact(s: &str, max_len: usize) -> String {

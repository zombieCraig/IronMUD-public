        ...
        switch (name) {
            ...
            case "update_area": {
                ...
                const area = await api.updateArea(id, {
                    ...
                    immigration_healer_chance: args?.immigration_healer_chance,
                    immigration_scavenger_chance: args?.immigration_scavenger_chance,
                    immigration_vampire_chance: args?.immigration_vampire_chance,
            ...
            case "create_mobile": {
                const mobile = await api.createMobile({
                    ...
                    deity: args?.deity,
                    patron_god_vnum: args?.patron_god_vnum,
                    world_max_count: args?.world_max_count,
            ...
            case "set_mobile_dialogue_tree_root": {
                ...
                if (!mobileId || !nodeName)
                    throw new Error("mobile_id and node_name are required");
            ...
            case "add_mobile_dialogue_node": {
                ...
                const r = await api.addDialogueNode(resolved, {
                    ...
                    on_each_visit: args?.on_each_visit,
            ...
            case "add_mobile_dialogue_choice": {
                ...
                const r = await api.addDialogueChoice(resolved, nodeName, {
                    ...
                    once_per_player: args?.once_per_player,
                });
                return { content: [{ type: "text", text: JSON.stringify(r.data, null, 2) + formatRefreshSuffix(r.refreshed_instances) }] };
            }
            ...
            case "create_spawn_point": {
                const spawnPoint = await api.createSpawnPoint({
                    ...
                    replace_on_respawn: args?.replace_on_respawn,
                });
                return {
                    content: [{ type: "text", text: JSON.stringify(spawnPoint, null, 2) }],
                };

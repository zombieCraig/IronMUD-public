    ...
    oneOf: [
        ...
        },
        {
            ...
            properties: {
                ...
                clan: {
                    ...
                    description: "Acknowledges a thinblood vampire into the named clan on completion. Sire defaults to the quest's giver_mob_vnum prototype name. No-op for mortals or already-acknowledged kindred.",
                },
            },
            required: ["kind", "clan"],
        },
        {
            ...
            properties: {
                ...
                discipline: {
                    type: "string",
                    description: "Optional hardcoded discipline (one of: potence, celerity, auspex, obfuscate, fortitude). Omit to let the reward read the player's runtime pick from the active quest's choice_vars[\"discipline\"] — set earlier in dialogue via SetQuestChoice. Lifts thinblood gates without claiming a clan; stamps the `anarch_unbound` trait and sets sire to \"Anarch Unbound\".",
                },
            },
            required: ["kind"],
        },

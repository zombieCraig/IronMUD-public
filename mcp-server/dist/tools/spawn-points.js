export const spawnPointToolDefinitions = [
    ...
    },
    {
        ...
        description: "Create a spawn point to make mobiles/items respawn. IMPORTANT: Without spawn points, entities will NOT respawn after death/pickup!",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Add an item that spawns WITH a mobile (e.g., equipment the mobile carries)",
        inputSchema: {
            type: "object",
            properties: {

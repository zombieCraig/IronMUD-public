...
export const auditToolDefinitions = [
    {
        name: "audit_room",
        description: "Grade one room and list what to fix. Checks descriptions, exits, dangling and one-way " +
    ...
    {
        name: "audit_item",
        description: "Grade one item prototype and list what to fix. Checks description, type, weapon dice, " +
    ...
    {
        name: "audit_mobile",
        description: "Grade one mobile prototype and list what to fix. Checks keyword coverage of the short " +
    ...
    {
        name: "audit_area",
        description: "Grade an area and everything in it: a rolled-up score, the area's own findings, and the " +
    ...
    {
        name: "audit_world",
        description: "Grade every area in the world plus world-level checks — cross-area connectivity, bulletin " +
            "boards, postmasters, unfiled prototypes. A full-world read.",
        inputSchema: { type: "object", properties: {} },
    },
    {
        name: "get_world_report",
        description: "How far along the world is: a named tier (Wilderness through World), the weighted " +
    ...
    },
    {
        ...
        description: "Builder progress tracks for this API key's builder: a checklist of engine systems, each " +

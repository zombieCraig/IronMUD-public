            ...
            properties: {
                ...
                flags: {
                    ...
                    properties: {
                        ...
                        private_room: { type: "boolean", description: "Caps player occupancy at 2 (Circle ROOM_PRIVATE). Alias: private." },
                        tunnel: { type: "boolean", description: "Caps player occupancy at 1 (Circle ROOM_TUNNEL)" },
                        death: { type: "boolean", description: "Instant-kill on player entry (Circle ROOM_DEATH)" },
                        ...
                        temple: { type: "boolean", description: "Sacred ground: `pray` here reaches a worshiper's god (worship tribute/blessing)" },
    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                description: { type: "string" },
                pickproof: { type: "boolean", default: false, description: "Door cannot be picked even by lockpick skill (Circle EX_PICKPROOF)" },
            },

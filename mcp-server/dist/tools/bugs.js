export const bugToolDefinitions = [
    {
        ...
        description: "List bug reports (only returns admin-approved reports). Use status filter to narrow results.",
        inputSchema: {
            type: "object",
            properties: {
                status: {
                    type: "string",
                    description: "Filter by status: Open, InProgress, Resolved, Closed. Omit for all approved reports.",
                },
            },
        },
    },
    {
        name: "get_bug_report",
        description: "Get a bug report by UUID or ticket number (only returns admin-approved reports). Accepts either a UUID or a ticket number.",
        inputSchema: {
            type: "object",
            properties: {
                identifier: {
    ...
    },
    {
        ...
        description: "Update a bug report's status and/or priority. Use ticket number or UUID as identifier.",
        inputSchema: {
            type: "object",
            properties: {
                identifier: {
    ...
    },
    {
        ...
        description: "Close a bug report with an optional resolution note",
        inputSchema: {
            type: "object",
            properties: {
                identifier: {
